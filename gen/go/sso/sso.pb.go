...
func (x *ReisterRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReisterRequest) ProtoMessage() {}

func (x *ReisterRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[0]
...
// Deprecated: Use ReisterRequest.ProtoReflect.Descriptor instead.
func (*ReisterRequest) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{0}
}

func (x *ReisterRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *ReisterRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
type LoginRequest struct {
	...
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` //ID to the app to login to.
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth of the logged in user.
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x42, 0x0a, 0x0e, 0x52, 0x65, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0xab, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x38, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x65, 0x72, 0x12, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x69, 0x73,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x08, 0x49, 0x73, 0x61, 0x64, 0x6d, 0x6d, 0x69, 0x6e,
	...
	0x12, 0x6b, 0x6f, 0x6e, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73,
...
var file_sso_sso_proto_goTypes = []interface{}{
	(*ReisterRequest)(nil),   // 0: auth.ReisterRequest
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.ReisterRequest
